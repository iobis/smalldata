...
public class LoginHandlerTest {
  ...
  private static final String AUTH_VERIFY_KEY =
  ...
  private static final String AUTH_SIGN_KEY =
  ...
  private static final JsonObject AUTH_CONFIG =
      new JsonObject()
          .put("alg", AUTH_ALG)
          .put("verifyKey", AUTH_VERIFY_KEY)
          .put("signKey", AUTH_SIGN_KEY);
  private static final JsonObject DEFAULT_CREDENTIALS =
        ...
        token ->
            loginHandler.verifyToken(
                ...
                (errorCode, errorMessage) ->
                    testContext.failNow(new Throwable("failed to verify"))),
