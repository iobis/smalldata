...
public class VerifyRSTokenTest {
  ...
  private static final String AUTH_PUBLIC_KEY =
      "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAsOuPRD4mbf8msGGmMC/w\n"
  ...
  void testJwtVerifier(Vertx vertx, VertxTestContext testContext) throws InterruptedException {
    authProvider =
        JWTAuth.create(
            ...
            new JWTAuthOptions()
                .addPubSecKey(
                    new PubSecKeyOptions().setAlgorithm(AUTH_ALG).setPublicKey(AUTH_PUBLIC_KEY)));
