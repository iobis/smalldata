...
public class MetaGeneratorTest {
  ...
  public void generateXmlSuccessFullMetaFile() throws IOException {
    ...
    var extensions =
        List.of("emof15584133909797684527.txt", "occurrence15584133909797684527.txt")
            .stream()
            .map(processor::uri)
    ...
    var generatedXmlFile =
        generator.generateXml(core, extensions, Files.createTempDirectory("iobis-dwca-meta"));
