...
public class DwcaComponentTest {
  ...
  private static final JsonObject DWCA_OCCURRENCE_RECORD =
      new JsonObject()
          .put(KEY_CORE, OCCURRENCE)
          .put(OCCURRENCE, new JsonArray().add(new JsonObject().put("iobis", new JsonObject())))
          .put(
              "emof",
              new JsonArray()
                  .add(
                      new JsonObject().put("purl", new JsonObject()).put("iobis", new JsonObject()))
  ...
  public static void deployVerticle(Vertx vertx, VertxTestContext testContext) {
    ...
    vertx.deployVerticle(
        DwcaComponent.class.getName(), testContext.succeeding(id -> testContext.completeNow()));
  }
  ...
  void generateZipFile(Vertx vertx, VertxTestContext testContext) {
    vertx
        ...
        .<JsonObject>send(
            "dwca",
            new JsonObject(Map.of(KEY_ACTION, "generate", "findDataset", "NnqVLwIyPn-nRkc")),
            ar -> {
              if (ar.succeeded()) {
        ...
        .<JsonObject>send(
            ...
            ar -> {
              if (ar.succeeded()) {
                ...
                assertThat(Duration.between(addedAtInstant, now))
        ...
        .<JsonArray>send(
            ...
            new JsonObject(
                Map.of(
                    ...
                    "find",
                    "query",
                    new JsonObject().put("user_ref", "FsfEMwhUTO_8I68"))),
            ar -> {
              if (ar.succeeded()) {
                ...
                records
                    ...
                    .forEach(
                        record ->
                            assertThat(record.getJsonObject("dwcRecords").containsKey(KEY_CORE))
                                .isTrue());
                testContext.completeNow();
              } else {
                testContext.failNow(ar.cause());
            ...
            new JsonObject(
                Map.of(
                    ...
                    new JsonObject()
                        .put(
                            "dwcRecord.id",
                            "IBSS_R/V N. Danilevskiy 1935 Azov Sea benthos data_1032"))),
            ar -> {
              if (ar.succeeded()) {
                JsonArray records = ar.result().body();
                ...
                assertThat(result.getMap())
                    .containsOnlyKeys("dataset", "dwcRecords", "addedAtInstant", "dwcaId");
