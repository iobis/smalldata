...
public class GenerateOpenApi {
  ...
  private static final Map<String, String> FILES_TO_PROCESS =
      Map.of(
  ...
  private final List<Function<Map<String, Map<String, Object>>, Map<String, Map<String, Object>>>>
      customizers = List.of(new TypeMapper(), new CustomFieldMerger());
