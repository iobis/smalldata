...
public class TableNamespaceMapper {
  ...
  private final List<String> specificNamespaceCols =
      KeyCollections.COL_HEADER_NAMESPACES
          .values()
          .stream()
          .flatMap(List::stream)
  ...
  Map<String, Object> mapTableNamespace(
      String namespace, Collection<String> keyCollection, Predicate<String> keyFilter) {
