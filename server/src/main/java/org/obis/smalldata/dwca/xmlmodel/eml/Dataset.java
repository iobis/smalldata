...
public class Dataset {
  ...
  @Value
  @RequiredArgsConstructor(onConstructor = @__({@ConstructorProperties({"language", "value"})}))
  static class Title {
  ...
  @Value
  @RequiredArgsConstructor(onConstructor = @__({@ConstructorProperties({"paragraphs"})}))
  ...
  @Value
  @RequiredArgsConstructor(onConstructor = @__({@ConstructorProperties({"url", "title"})}))
  ...
  static class PersonData {
    ...
    @Value
    @RequiredArgsConstructor(onConstructor = @__({@ConstructorProperties({"country"})}))
