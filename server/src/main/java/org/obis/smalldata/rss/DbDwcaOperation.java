    ...
    mongoClient.runCommand("aggregate",
        new JsonObject()
            ...
            .put("pipeline", new JsonArray()
                .add(new JsonObject()
                    .put("$sort", new JsonObject().put("addedAtInstant", -1)))
                .add(new JsonObject()
                ...
                .add(new JsonObject()
                    .put("$project", new JsonObject()
                        ...
                        .put("addedAtInstant", new JsonObject()
                            .put("$ifNull", new JsonArray().add("$latest.addedAtInstant").add(Instant.EPOCH.toString())))))
                .add(new JsonObject()
